...
- Le tableau des tailles d'instance, dans la documentation de l'API, est refait avec de nouvelles mesures sur Clever Cloud : une ligne par zoom, avec la taille de l'image et sa mémoire, une colonne par taille d'instance, les durées avec et sans cache, et le zoom maximal à régler pour chaque taille.
